...
public class CheckImgAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		// æ­¥éª¤ä¸ ç»å¶ä¸å¼ åå­ä¸­å¾ç
		BufferedImage bufferedImage = new BufferedImage(width, height,
				BufferedImage.TYPE_INT_RGB);

		// æ­¥éª¤äº å¾çç»å¶èæ¯é¢è² ---éè¿ç»å¾å¯¹è±¡
		Graphics graphics = bufferedImage.getGraphics();// å¾å°ç»å¾å¯¹è±¡ --- ç»ç¬
		// ç»å¶ä»»ä½å¾å½¢ä¹å é½å¿é¡»æå®ä¸ä¸ªé¢è²
		...
		Random random = new Random();// çæéæºæ°
		// å®ä¹StringBuffer
		...
		for (int i = 0; i < 4; i++) {
			...
			// çæä¸ä¸ªéæºæ°å­
			int index = random.nextInt(words.length()); // çæéæºæ° 0 å° length - 1
			// è·å¾å­æ¯æ°å­
		...
		// å°ä¸é¢å¾çè¾åºå°æµè§å¨ ImageIO
		graphics.dispose();// éæ¾èµæº
